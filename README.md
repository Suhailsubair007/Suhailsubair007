...
- Leading full-stack mobile & backend engineering at **[Deelo](https://deelo.in)**
- Architecting cross-platform **iOS & Android** apps with React Native
- Improved API latency by **40%** through query optimization & caching
- Engineering real-time systems with **WebSockets** & event-driven services
- Designing **CI/CD pipelines** and cloud infrastructure on **AWS · DigitalOcean · GCP**
...
**Mobile** React Native · Expo · NativeWind · Redux Toolkit &nbsp;•&nbsp; **Backend** Bun · Socket.IO · REST · GraphQL &nbsp;•&nbsp; **Infra & DevOps** DigitalOcean · GCP · Nginx · Cloudflare R2 · PM2 &nbsp;•&nbsp; **Tooling** Git · Postman · Figma · EAS Build

## Deelo

<div align="center">

**An on-demand marketplace connecting Kerala with trusted local services & delivery.**
...
Production-grade MERN e-commerce featuring secure authentication (OAuth2, OTP, JWT), Razorpay payment integration, and a role-based admin dashboard with real-time analytics.
`Node.js` `React` `MongoDB` `Tailwind CSS` `AWS EC2` `Nginx`
